...
// RepositoryEntity struct for RepositoryEntity
...
func (o RepositoryEntity) MarshalJSON() ([]byte, error) {
...
type NullableRepositoryEntity struct {
	value *RepositoryEntity
	isSet bool
}

func (v NullableRepositoryEntity) Get() *RepositoryEntity {
	return v.value
}

func (v *NullableRepositoryEntity) Set(val *RepositoryEntity) {
	v.value = val
	v.isSet = true
}

func (v NullableRepositoryEntity) IsSet() bool {
	return v.isSet
}

func (v *NullableRepositoryEntity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRepositoryEntity(val *RepositoryEntity) *NullableRepositoryEntity {
	return &NullableRepositoryEntity{value: val, isSet: true}
}

func (v NullableRepositoryEntity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRepositoryEntity) UnmarshalJSON(src []byte) error {
	v.isSet = true
